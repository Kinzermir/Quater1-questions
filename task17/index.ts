...
// // Original array containing names of people to invite to dinner
// let guests: string[] = ["Albert Einstein", "Ada Lovelace", "Nelson Mandela", "Marie Curie", "Leonardo da Vinci", "Rosa Parks", "Isaac Newton", "Galileo Galilei", "Stephen Hawking"];
...
//     let removedGuest: string = guests.pop()!; // Remove the last guest
//     console.log(`Sorry, ${removedGuest}, I'm unable to invite you to dinner.`);
// }
...
// // Sending out invitations to the remaining two guests
// guests.forEach(guest => {
//     console.log(`Dear ${guest}, you're still invited to dinner. Hope to see you there!`);
// });
